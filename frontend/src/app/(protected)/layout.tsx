      ...
      <div className="w-64 bg-[#4A5D5A] text-white min-h-screen">
        ...
        <nav className="mt-8">
          <div className="px-4 space-y-2">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m-9 0a2 2 0 012-2v-6a2 2 0 012-2v6a2 2 0 012 2v6a2 2 0 012 2v6a2 2 0 012-2v-6a2 2 0 012-2h2m-6 0h6v-4h-6v4m6 0h-6v4h6v-4" />
              </svg>
              Company
            </Link>
          </div>
